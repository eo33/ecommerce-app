 ...
 *     requestBody:
 *       description:
 *         A JSON object containing the _address_ of the user.
 *       required: true
 *       content:
 *         application/json:
 *           schema:
 ...
 *     description: This endpoint allows you to change your main address.
 *     tags:
 *       - Address
 *     security:
 *       - APIKey: []
 *     requestBody:
 *       description: A JSON object containing the _addressId_ to be selected as the main address. The _addressId_ should correspond to an address that a user has.
 *       required: true
 *       content:
 *         application/json:
 *           schema:
 ...
 *       - APIKey: []
 *     requestBody:
 *       description: A JSON object containing the _addressId_ to be deleted. The _addressId_ should correspond to an address that a user has.
 *       required: true
 *       content:
 *         application/json:
 *           schema:
